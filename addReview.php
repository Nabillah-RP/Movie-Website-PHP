...
<div style="color: white; font-size: 20px; text-align: right; margin-right: 25px;">
    ...
    ?> 
         ...
         <h2 style="text-align: center;">Add Review for <?php echo $movieTitle; ?> </h2>
         
        <div style="text-align: center;" class="container my-5 border bg-secondary text-black">
            
            <form style="padding-top: 25px; padding-bottom: 25px; font-size: 20px;" id="postForm" action="doAddReview.php?id=<?php echo $theID; ?>" method="post">
            ...
            <textarea id="idDesc" name="comments" rows="3" cols="30" required></textarea><br/><br/>	
            
            <label for="idPrice">Rating:</label>
            <select name="rating" id="numbers"><br/><br/>	
